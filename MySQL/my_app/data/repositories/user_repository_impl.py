...
class UserRepositoryImpl(BaseRepositoryImpl[UserDBModel], IUserRepository[UserDBModel]):
    def __init__(self, session: Session) -> None:
        super().__init__(session, UserDBModel)

    def add(self, entity: User) -> User:
        db_user = UserDBModel(**entity.model_dump(exclude_unset=True))
